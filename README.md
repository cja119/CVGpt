...
This GitHub repository allows you to build a custom Large Language Model based off your CV (or any other relevant documents), that forms an AI chatbot that can be hosted online for others to access, and make queried regarding your work.
